...
# Skrift-familier der tæller som "serif" — vælger Lars en af dem i Doc'et
# (fx Times New Roman til et digt), markeres afsnittet med class="serif",
# som Tekster-siden viser i en serif-webfont. Alt andet vises i sidens
# egen skrift (Inter) — vi slipper bevidst ikke vilkårlige fonte løs.
